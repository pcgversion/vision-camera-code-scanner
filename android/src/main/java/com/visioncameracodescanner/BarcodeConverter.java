...
public class BarcodeConverter {
  public static List<Map<String, Integer>> convertToArray(@NonNull Point[] points) {
  ...
  public static List<String> convertStringList(@NonNull List<String> elements) {
    // Return a new list to avoid potential modification issues if the original list is used elsewhere,
    // or simply return `elements` if that's not a concern.
    return new ArrayList<>(elements);
  }

  public static List<Map<String, Object>> convertAddressList(@NonNull List<Barcode.Address> addresses) {
  ...
  public static List<Map<String, Object>> convertPhoneList(@NonNull List<Barcode.Phone> phones) {
    List<Map<String, Object>> array = new ArrayList<>();
  ...
  public static List<Map<String, Object>> convertEmailList(@NonNull List<Barcode.Email> emails) {
    List<Map<String, Object>> array = new ArrayList<>();
  ...
  public static Map<String, Integer> convertToMap(@NonNull Point point) {
  ...
  public static Map<String, Integer> convertToMap(@NonNull Rect rect) {
    Map<String, Integer> map = new HashMap<>();
  ...
  public static Map<String, String> convertToMap(@NonNull Barcode.PersonName name) {
  ...
  public static Map<String, String> convertToMap(@NonNull Barcode.UrlBookmark url) {
    Map<String, String> map = new HashMap<>();
  ...
  public static Map<String, String> convertToMap(@NonNull Barcode.Sms sms) {
    Map<String, String> map = new HashMap<>();
  ...
  public static Map<String, Double> convertToMap(@NonNull Barcode.GeoPoint geoPoint) {
  ...
  public static Map<String, String> convertToMap(@NonNull Barcode.DriverLicense driverLicense) {
    Map<String, String> map = new HashMap<>();
