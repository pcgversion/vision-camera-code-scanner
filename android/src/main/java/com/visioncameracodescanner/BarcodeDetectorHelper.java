...
public class BarcodeDetectorHelper {
    ...
    public BarcodeDetectorHelper(String modelName, Integer detectorMode, Boolean shouldEnableClassification,
            Boolean shouldEnableMultipleObjects, Integer modelImageSize, Float thresold,
        ...
        for (int i = 0; i < output[0].length; i++) {
            ...
            if (confidence >= threshold) {
                ...
                for (PointF pt : corners) {
                    mappedCorners
                            .add(mapToOriginalImage(pt, this.modelSize, this.modelSize, originalWidth, originalHeight));
                }
